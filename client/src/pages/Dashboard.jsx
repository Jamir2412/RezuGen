...
import {FilePenIcon, PencilIcon, Plus, TrashIcon, UploadCloudIcon} from 'lucide-react'
    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          ...
          border-slate-3 group hover:border-indigo-500 hover:shadow-lg transition-all
        ...
        <hr className="border-slate-300 my-6 sm:w-w[305px"/>
        ...
        <div className= "grid grid-cols-2 sm:flex flex-wrap gap-4">
          {
            allResumes.map((resume,index)=>{
              ...
              return (
                ...
                flex-col items-center justify-center rounded-lg gao-2 border group *:hover:shadow-lg transition-all
                duration-300 cursor-pointer" style={
                  ...
                  <p className="text-sm group-hover:scale-105 transition-all px-2text-center" style={{color: baseColor}}>
                    {resume.title}
                  </p>
                  ...
                  <div className="absolute top-1 right-1 group-hover:flex items-center hidden">
                    <TrashIcon className= "size-7 p-1.5 hover:bg-white/50 rounded-2xltext-slate-700 transition-colors"/>
                    <PencilIcon className= "size-7 p-1.5 hover:bg-white/50 rounded-2xltext-slate-700 transition-colors"/>
                  </div>
                </button>
              )
            })
