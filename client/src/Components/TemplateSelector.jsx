  ...
  return (
    ...
    <div className='relative'>
        <button onClick={()=>setIsOpen(!isOpen)}
            ...
            bg-gradient-to-br frm-blue-500 to-blue-100
                ...
                rounded-md border border-gray-200'>
                    {
                        templates.map((template)=>(
                            <div key={template.id} onClick={()=>{onChange(template.id);
                                ...
                                transition-all ${selectedTemplate=== template.id ? "border-blue-400 bg-blue-100": "border-gray-300 hover:border-gray-400 hover:bg-gray-100"}`}>
                                    {
                                    ...
                                    <div className='space-y-1'>
                                        ...
                                        text-gray-500'>{template.preview}</div>
                                    </div>
                            </div>
                        ))
                    }
