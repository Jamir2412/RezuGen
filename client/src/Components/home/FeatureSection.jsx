...
const FeatureSection = () => {
  ...
  return (
    ...
    >
      ...
      <Title title="Build Your Resume"  description="Our streamedline process helps you create a professional resume in minutes with intelligent AI-powered tools and features"/>
