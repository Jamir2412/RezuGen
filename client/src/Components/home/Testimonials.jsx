...
const Testimonials = () => {
  ...
  return (
    ...
    <div
      ...
      <Title title="Don't just take our words"  description="Hear what our user say about us. We're always looking for ways to imporve. If you have a positive experiance with us, leave us a review"/>
    </div>
